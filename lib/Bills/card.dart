            ...
            children: [
             SizedBox(
              ...
              Column(
                ...
                children: [
                  Text("Bills #1",style: TextStyle(color:Colors.black,fontSize: 16, fontWeight: FontWeight.bold),),
                  SizedBox(height: 3,),
                  Text("2/12/2021",style: TextStyle(color:Colors.grey,fontSize: 14, fontWeight: FontWeight.bold),),
                  SizedBox(height: 3,),
                  Text("150 SR",style: TextStyle(color:Colors.grey,fontSize: 14, fontWeight: FontWeight.bold),),
                ],
              ),
            ],
          ),
